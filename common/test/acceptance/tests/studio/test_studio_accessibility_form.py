...
class AccessibilityPageTest(AcceptanceTest):
    ...
    @ddt.data(
        ('email', 'Valid email', '', 'Bok-choy', 'I\'m testing you.'),
        ('fullName', 'Full name', 'bokchoy@edx.org', '', 'I\'m testing you.'),
        ('message', 'Message', 'bokchoy@edx.org', 'Bok-choy', ''),
    )
    @ddt.unpack
    ...
    def test_error_messages(self):
        self.accessibility_page.visit()
        self.check_error_message('email', 'Valid email')
        self.check_error_message('fullName', 'Full name')
        self.check_error_message('message', 'Message', field_type='textarea')
